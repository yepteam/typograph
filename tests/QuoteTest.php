...
EOF
    ...
    public function testQuotesInHtml()
    {
        ...
        // Закрывающая кавычка перед тегом переноса строки не должна
        // считаться открывающей из-за следующего за тегом слова
        $original = '<td>Государственное образовательное учреждение высшего профессионального образования "Пермский государственный технический университет"<br>Квалификация: инженер</td>';
        $expected = '<td>Государственное образовательное учреждение высшего профессионального образования «Пермский государственный технический университет»<br>Квалификация: инженер</td>';
        $this->assertSame($expected, $typograph->format($original));
    }
